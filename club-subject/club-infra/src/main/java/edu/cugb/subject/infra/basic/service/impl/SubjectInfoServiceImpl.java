...
import edu.cugb.subject.infra.basic.mapper.SubjectInfoDao;
...
public class SubjectInfoServiceImpl implements SubjectInfoService {
    ...
    @Override
    public List<SubjectInfo> queryPage(SubjectInfo subjectInfo, int start, Integer pageSize, Long categoryId, Long labelId) {
        return this.subjectInfoDao.queryPage(subjectInfo, start, pageSize, categoryId, labelId);
    }
}
